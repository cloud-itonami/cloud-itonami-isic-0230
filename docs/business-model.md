# Business Model: Gathering of Non-Wood Forest Products Coordination
...
## Classification
- Repository: `cloud-itonami-isic-0230` ([github.com/cloud-itonami/cloud-itonami-isic-0230](https://github.com/cloud-itonami/cloud-itonami-isic-0230))
- ISIC Rev.5: `0230` — Gathering of Non-Wood Forest Products Coordination
- Domain: `:agriculture/nwfp-gathering`
- Social impact: :rural-employment :biodiversity-stewardship :sustainable-livelihoods
- Actor: `:nwfp-gathering-coordination-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :agriculture/nwfp-gathering — who wants
...
Capability stack (required): :forest-ecology :identity :forms :dmn :audit-ledger :scheduling.
...
One managed tenant (:agriculture/nwfp-gathering):
...
- Do not bypass the `:nwfp-gathering-coordination-governor` for production decisions.

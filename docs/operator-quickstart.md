# Operator Quickstart — Gathering of Non-Wood Forest Products Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0230** (`cloud-itonami-isic-0230`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0230.git
cd cloud-itonami-isic-0230
```
...
- Blueprint governor key: `nwfp-gathering-coordination-governor`
- Likely source path: `nwfp.governor.cljc`
